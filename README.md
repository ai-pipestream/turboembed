...
| `inferstream-intel` | Intel Linux (e.g. **krick-1**, Arc/Battlemage) | **llama.cpp-SYCL** (oneAPI/Level Zero) and **OpenVINO** — bake-off pending; ORT CPU available via `ort-runtime` | engine links stubbed |
