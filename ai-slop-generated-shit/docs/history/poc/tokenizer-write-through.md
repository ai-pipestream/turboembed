...
`docs/bench-turbo-machine-a.md`). Machine B OpenVINO bench is LIVE
(`make bench-machine-b-ov`, `docs/solidify-bench-machine-b.md`).
SentencePiece / Unigram models we do not own (BGE-M3 etc. keep the HF
tokenizer).
