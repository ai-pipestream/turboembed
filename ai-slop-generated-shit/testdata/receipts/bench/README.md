...
| `machine-c-metal-overhead.json` | **C** (Apple) | direct mlx-swift Metal vs `libTurboEmbed.dylib` ABI | `make bench-apple-overhead` — **LIVE**; validated by `cargo test -p turboembed --features mlx-live --test apple_overhead_receipt -- --ignored`; see [checklist step 4](../../../docs/apple-m4-machine-c-checklist.md) |
